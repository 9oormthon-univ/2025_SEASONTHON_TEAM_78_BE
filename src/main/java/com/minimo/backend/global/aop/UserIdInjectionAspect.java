package com.minimo.backend.global.aop;

import com.minimo.backend.global.jwt.JwtAuthentication;
...
public class UserIdInjectionAspect {
    @Pointcut("@annotation(com.minimo.backend.global.aop.AssignUserId) && (args(userId, ..) || args(.., userId))")
